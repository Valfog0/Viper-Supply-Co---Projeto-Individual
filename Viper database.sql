...
('Carlos Silva', 'carlos.silva@email.com', 'senhaHash1', 1, 2), -- PM, Nordeste
('Maria Souza', 'maria.souza@email.com', 'senhaHash2', 2, 4),   -- PC, Sudeste
('João Lima', 'joao.lima@email.com', 'senhaHash3', 5, 1);       -- AgFed, Norte

INSERT INTO usuario_topicos (id_usuario, id_topico) VALUES
(1, 1); -- Equip 
...
SELECT u.id_usuario, u.nome, u.email, c.nome_cargo, r.nome_regiao
FROM usuarios u
